 ...
 * @return Undefined
 */
const renameFile = (oldFileUrl, type, repstr, separator, excludeType) => {
 ...
 * @return {*}
 */
const baseFilesReaname = ({ baseUrl, type, repstr, separator, excludeType }) => {
    readdir(baseUrl).then(e => {
        renameFile(e, type, repstr, separator, excludeType)
    })
}
module.exports = {
    baseFilesReaname
