...
async function pathInput() {
  let result = await inquirer.prompt([
    ...
    },
    {
      ...
      type: "input",
      message:
        "please input include file types separate with ,?  eg: 'css,png,pdf'",
    },
    {
      name: "excludeType",
      type: "input",
      message:
        "please input exclude file types separate with ,?  eg: 'css,png,pdf'",
    },
  ]);
  const excludeType =
    (result.excludeType.trim() && result.excludeType.split(",")) || [];
